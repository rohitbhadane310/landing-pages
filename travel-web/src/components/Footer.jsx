...
const Footer = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5 bg-darkBackground text-white">
      ...
      <div>
        <h1 className=" font-medium text-xl pb-4 pt-5 md:pt-0">Destination</h1>
